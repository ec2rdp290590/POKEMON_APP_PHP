...
// Buscar Pokémon si hay un término de búsqueda
if (isset($_GET['search']) && !empty($_GET['search'])) {
    $pokemonUrls = $pokemonService->searchPokemonByName($_GET['search']);
} else {
...
foreach ($pokemonUrls as $url) {
    ...
    if ($pokemon && !$dataStore->isPokemonHidden($pokemon->id)) {
        $pokemonList[] = $pokemon;
    }
}

// Obtener IDs de Pokémon con "me gusta"
$likedPokemonIds = $dataStore->getLikedPokemonIds();
?>
